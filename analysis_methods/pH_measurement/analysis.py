...
def run_pH_measurement (date_dir, last_frame, first_frame, conditions, background_percent, YFP_channel, FRET_channel):
    ...
    for condition in conditions:
        ...
        title_row_list = [['Filename', '5min radius', '6min radius', '7min radius', '8min radius', '9min radius', '10min radius', '11min radius', '12min radius', '13min radius', '14min radius', '15min radius', '16min radius', '5min intensity pH-sensitive', '6min intensity pH-sensitive', '7min intensity pH-sensitive', '8min intensity pH-sensitive', '9min intensity pH-sensitive', '10min intensity pH-sensitive', '11min intensity pH-sensitive', '12min intensity pH-sensitive', '13min intensity pH-sensitive', '14min intensity pH-sensitive', '15min intensity pH-sensitive', '16min intensity pH-sensitive',
                            '5min background pH-sensitive', '6min background pH-sensitive', '7min background pH-sensitive', '8min background pH-sensitive', '9min background pH-sensitive', '10min background pH-sensitive', '11min background pH-sensitive', '12min background pH-sensitive', '13min background pH-sensitive', '14min background pH-sensitive', '15min background pH-sensitive', '16min background pH-sensitive',
                            '5min intensity pH-insensitive', '6min intensity pH-insensitive', '7min intensity pH-insensitive', '8min intensity pH-insensitive', '9min intensity pH-insensitive', '10min intensity pH-insensitive', '11min intensity pH-insensitive', '12min intensity pH-insensitive', '13min intensity pH-insensitive', '14min intensity pH-insensitive', '15min intensity pH-insensitive', '16min intensity pH-insensitive',
                            '5min background pH-insensitive', '6min background pH-insensitive', '7min background pH-insensitive', '8min background pH-insensitive', '9min background pH-insensitive', '10min background pH-insensitive', '11min background pH-insensitive', '12min background pH-insensitive', '13min background pH-insensitive', '14min background pH-insensitive', '15min background pH-insensitive', '16min background pH-insensitive']]
